...
public class FacturaController {
	...
	public String ver(@PathVariable(value="id") Long id,
		...
		Factura factura = clienteService.fetchByIdWithClienteWhitItemFacturaWithProducto(id);  //findFacturaById(id);
		...
		model.addAttribute("titulo", "Detalle ".concat(factura.getDescripcion()));
		return "factura/ver";
	}
	...
	public String guardar( @Valid Factura factura,
		...
		if (result.hasErrors()) {
			model.addAttribute("titulo", "Crear Factura Rr");
			return "factura/form";
		}
		...
		clienteService.saveFactura(factura); // insert la factura , ademas, inserta los items_factura
		log.info("despues");
		status.setComplete();
	...
	public String  eliminar(@PathVariable(value="id") Long id,
		...
		if(factura != null) {
			...
			flash.addFlashAttribute("success", "Factura eliminada con exit0");
			return "redirect:/ver/"+factura.getCliente().getId();
		}
		flash.addFlashAttribute("error", "la factura no existe en la BBDD");
		return "redirect:/listar";
